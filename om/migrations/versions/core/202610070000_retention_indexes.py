...
def upgrade() -> None:
    run_sql(DatabaseRole.CORE, "202610070000_retention_indexes.up.sql")


def downgrade() -> None:
    run_sql(DatabaseRole.CORE, "202610070000_retention_indexes.down.sql")
